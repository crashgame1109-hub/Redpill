...
/**
 * Баланс самого приложения в Crypto Pay — сколько реальной крипты сейчас лежит
 * на кошельке бота (по каждому активу отдельно). Именно ОТСЮДА уходят реальные
 * деньги при подтверждении вывода (transferCrypto выше) — полезно видеть в
 * админке, чтобы вовремя пополнить, если баланс проседает ниже суммы заявок.
 */
